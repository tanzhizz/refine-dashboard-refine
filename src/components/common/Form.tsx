import { Typography, Box, Stack, FormControl, FormHelperText, TextField, TextareaAutosize, Select, MenuItem, Button, borderColor } from "@pankod/refine-mui";
        ...
        >
          ...
          <Stack direction="column" gap={1} justifyContent="center" mb={2}>
            <Stack direction="row" gap={2}>
              <Typography color="#11142d" fontWeight={500} fontSize={16} my="10px">
                Property Photo
              </Typography>
